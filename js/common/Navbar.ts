...
export default class Navbar {
  ...
  private expandItemsListButtonLineElements =
    expandNavbarItemsListButtonStrips_spans;
  ...
  private toggleElementExpandedAttribute(element: HTMLElement) {
    element.setAttribute(
      'data-expanded',
      (!parseBool(element.getAttribute('data-expanded'))).toString()
    );
  }
  ...
  public isExpanded() {
    return (
      ...
      parseBool(this.itemListElement.getAttribute('data-expanded'))
    );
  }
}
